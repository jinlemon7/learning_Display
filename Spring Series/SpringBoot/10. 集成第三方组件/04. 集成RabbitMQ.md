...
# 安装RabbitMQ
  ...
  <img width="506" height="225" alt="image" src="https://github.com/user-attachments/assets/8d71b734-c1a5-413b-a9b2-a70a71475827" />  
...
# AMQP协议
  ...
  <img width="640" height="325" alt="image" src="https://github.com/user-attachments/assets/4df5f9e0-e523-4cee-a6be-7ebc2506aa42" />  
  ...
  <img width="335" height="304" alt="image" src="https://github.com/user-attachments/assets/9825de60-5488-41f2-a5fe-b02cd8cb118f" />  

  上述Binding的规则就是：凡是发送到registration这个Exchange的消息，均被发送到q_mail和q_sms这两个Queue。  

  我们再创建一个Direct类型的Exchange，命名为login，并添加如下Binding：  
  <img width="313" height="345" alt="image" src="https://github.com/user-attachments/assets/80ec0a54-e76a-4aa7-8cc9-633ea31a26e3" />  
